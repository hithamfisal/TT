      ...
      >
        ...
        {data && (
          <>
            ...
            {monthlyExportTickets.length > 0 && (
              <div className="hero-export-row no-print">
                <aside className="hero-export-card" aria-label="Monthly Performance filter">
                  <div className="hero-export-copy">
                    <span>Monthly Performance</span>
                    <strong>
                      <span className="export-badge">{monthlyExportTickets.filter((t) => perfRegion === "ALL" || t.primary.region === perfRegion).length}</span>
                      Performance for {perfMonth === "all" ? "All Months" : formatMonthMMMMYYYY(perfMonth)}
                    </strong>
                  </div>
